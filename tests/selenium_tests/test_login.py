...
class TestHomePage(BaseClass):
    def test_successfull_Login(self):
        ...
        self.verfify_current_url('https://www.hudl.com/home')
    ...
    def test_unsuccessful_Login(self):
        ...
        loginPage.click_login_button()
        self.verfify_elements_exist(homePage.login_error_banner)
    ...
    def test_password_reset(self):
        ...
        self.verfify_current_url('https://www.hudl.com/login/help')
        ...
        self.verfify_current_url('https://www.hudl.com/login/check-email')
